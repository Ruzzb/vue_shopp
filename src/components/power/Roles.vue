            ...
            <!-- 索引列 -->
               ...
               <el-table-column  label="操作">
                   <template slot-scope="scope">
                       ...
                       <el-button type="warning" icon="el-icon-setting" size="mini" width="30px" @click="showSetRightDialog(scope.row)">分配权限</el-button>
                   </template>
               </el-table-column>
           </el-table>
       </el-card>
...
export default {
  ...
  methods: {
    ...
    async removeRightById(role, rightId) {
      ...
      // 重新获取权限列表数据（刷新列表）
      // this.getRolesList() 直接调用会将页面数据全部刷新，造成操作麻烦
    ...
    async showSetRightDialog(role) {
      ...
      // 递归获取三级节点的Id  defkeys调用时需要清空
      this.getLeafKeys(role, this.defKeys)
      this.setRightDialogVisible = true
    },
    // 通过递归的形式，获取角色下的所有三级权限，并保存到defKeys数组中
    ...
    // 监听分配权限的对话框关闭事件,关闭对话框并清空defKeys数组
