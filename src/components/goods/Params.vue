...
export default {
  ...
  methods: {
    ...
    // 点击按钮，展示文本输入框
    showInput(row) {
      row.this.inputVisible = true
      // 让文本框自动获得焦点
      // $nextTick:当页面上的元素被重新渲染后，才会指定回调函数中的代码   _相当于()
      this.$nextTick(_ => {
